...
import { X, Loader2, Printer, CheckCircle, AlertCircle } from 'lucide-vue-next'
...
async function handlePrint() {
  ...
  try {
    ...
    toast.success(`Label pengiriman untuk ${props.orderIds.length} order berhasil dicetak`)
    emit('success')
    emit('close')
  }
  catch (err: any) {
    ...
    let errorMessage = 'Gagal mencetak label pengiriman'
          ...
          >
            ...
            <div class="max-h-[60vh] overflow-y-auto px-6 py-5">
              <div class="space-y-4">
                ...
                <div class="flex items-start gap-3 rounded-lg bg-blue-50 p-4 ring-1 ring-blue-200">
                  <Printer class="h-5 w-5 shrink-0 text-blue-600" />
                  <div>
                    <p class="text-sm font-medium text-blue-900">
                      Label akan dicetak dalam format PDF
                    </p>
                    <p class="mt-1 text-xs text-blue-700">
                      PDF akan terbuka di tab baru setelah proses selesai
                    </p>
                  </div>
                </div>
            ...
            <div class="flex items-center justify-end gap-2 border-t border-gray-200 px-6 py-4">
              ...
              >
                ...
                {{ processing ? 'Mencetak...' : 'Cetak Label' }}
              </button>
            </div>
          </div>
        </Transition>
