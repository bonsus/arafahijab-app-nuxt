...
import {
  ClipboardList, Wallet, Package, Users,
...
watch(() => [props.search, props.status, props.supplierIds, props.warehouseIds, props.dateType, props.dateFrom, props.dateTo], () => {
  fetchRecap()
}, { deep: true })
  ...
  <div class="grid grid-cols-1 gap-3 sm:grid-cols-4">
    ...
    <div class="rounded-xl bg-white p-4 shadow-xs ring-1 ring-gray-200">
      <div class="flex items-center gap-3">
        ...
        <div class="min-w-0">
          <p class="text-xs text-gray-500">Total GRN</p>
      ...
      <div v-if="!loading && recap" class="mt-2.5 flex flex-wrap gap-x-3 gap-y-0.5 text-xs">
        ...
        <span class="text-blue-600">{{ recap.total_received }} Diterima</span>
    ...
    <div class="rounded-xl bg-white p-4 shadow-xs ring-1 ring-gray-200">
      ...
      <div v-if="!loading && recap" class="mt-2.5 flex flex-wrap gap-x-3 gap-y-0.5 text-xs">
        <span class="text-emerald-600">{{ recap.total_qty_good }} Baik</span>
        <span class="text-orange-500">{{ recap.total_qty_returned }} Retur</span>
      </div>
    </div>
