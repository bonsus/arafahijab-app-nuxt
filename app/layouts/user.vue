...
const sidebarCollapsed = useCookie('user-sidebar-collapsed', { default: () => 'true' })
    ...
    <nav class="bg-white shadow-sm border-b border-gray-200 fixed w-full top-0 z-50">
      <div class="flex items-center justify-between px-4 h-14">
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-2" @click="navigateTo('/app')">
            <div class="w-auto h-8 rounded-lg flex items-center justify-center">
