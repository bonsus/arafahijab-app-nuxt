...
import {
  ...
  Pencil, RefreshCw, ArrowLeftRight, Layers, Download, Loader2, ChevronDown,
...
async function exportData(endpoint: string) {
  ...
  try {
    ...
    const name = 'stock_conversion_' + (endpoint.split('/').pop() || 'export').replace(/-/g, '_')
  ...
  <div class="space-y-5">
    ...
    <div class="flex flex-wrap items-center gap-2">
      ...
      <div class="relative" @click.stop>
        ...
        >
          <button class="flex w-full items-center gap-2 px-4 py-2.5 text-sm text-gray-700 transition-colors hover:bg-gray-50" @click="exportData('/inventories/conversions/export')">
            Konversi Stok
          </button>
          <button class="flex w-full items-center gap-2 px-4 py-2.5 text-sm text-gray-700 transition-colors hover:bg-gray-50" @click="exportData('/inventories/conversions/export-with-items')">
            Konversi Stok With Items
          </button>
        </div>
      </div>
    </div>
